...
function Footer() {
    ...
    return (
        <div>
            <footer className="tp-header-height" style={{
                width: '100%',
                minHeight: '150px',
                ...
                <div style={{
                    ...
                    <div style={{ color: 'white', marginLeft: '100px' }}>{t('Links')}: <br /><a href="https://mafm.hkust.edu.hk/" style={{ color: 'white' }}>Crypto-Fintech Lab<br />HKUST MAFM</a></div>
